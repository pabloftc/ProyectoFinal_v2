...
export default function CourseInscription() {
  ...
  return (
    <div className="container justify-content-center text-center w-75 py-5">
      <form
        className="mt-5 px-3"
      ...
      >
        ...
        {/* { Descripción } */}
        <div className="form-floating mb-4 fs-5">
          <textarea
        ...
        <div className="input-group mb-3">
          {/* <label className="input-group-text py-0 px-1 border-0" htmlFor="inputGroupFile">
            PDF
          </label> */}
          <input
            name="doc-curso"
